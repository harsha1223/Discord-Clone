...
import { selectChannalId, selectChannalName } from './features/appSlice';
import { selectUser } from './features/userSlice';
import db from './firebase';
import firebase from 'firebase';

function Chat() {
    const channelId = useSelector(selectChannalId);
    const user = useSelector(selectUser);
    const channelName = useSelector(selectChannalName);
